...
import PanelMemberDashboard from './Components/PanelMember/PanelMemberDashboard';
    ...
    <Provider store={store}>
      <Router>
        ...
        <Switch>
          ...
          <Route path="/panelDashboard" component={PanelMemberDashboard}></Route>
          ...
          <Route exact path="/chatapp" component={ChatHome}></Route>
          <Route exact path="/chats" component={ChatApp} ></Route>
