          ...
          <div className='col'>
              <div class="card" style={{ width: '18rem' }}>
                  ...
                  <div class="card-body">
                      ...
                      <br/><br/>
                      <a href="/panelDashboard" class="btn btn-primary">Panel Member</a>&nbsp;
          ...
          <div className='col'>
              <div class="card" style={{ width: '18rem' }}>
                  ...
                  <div class="card-body">
                      ...
                      <br/><br/>
                      <a href="/login1" class="btn btn-primary">Student</a>&nbsp;
          ...
          <div className='col'>
              <div class="card" style={{ width: '18rem' }}>
                  ...
                  <div class="card-body">
                      ...
                      <br/><br/>
                      <a href="/login2" class="btn btn-primary">Supervisor/Co-supervisor</a>&nbsp;
